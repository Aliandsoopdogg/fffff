...
def get_pages():
    ...
    # u = requests.get(url='https://shop.casio.ru/catalog/g-shock/filter/gender-is-male/apply/', headers=headers)

    # if not os.path.exists("data"):
    #     os.mkdir("home_work/data")

    # with open("home_work/data/page_1.html", "w") as file:
    #     file.write(u.text)

    with open("home_work/data/page_1.html") as file:
        src = file.read()
    ...
    for i in range(1, pages_count + 1):
        ...
        with open(f"home_work/data/page_{i}.html", "w") as file:
            file.write(u.text)
...
def collect_data(pages_count):
    ...
    with open(f"home_work/data_{cur_date}.csv", "w") as file:
    ...
    for page in range(1, pages_count):
        with open(f"home_work/data/page_{page}.html") as file:
            src = file.read()
        ...
        for item in items_cards:
            ...
            with open(f"home_work/data_{cur_date}.csv", "a") as file:
                writer = csv.writer(file)
    ...
    with open(f"home_work/data_{cur_date}.json", "a") as file:
